...
models.Register = ({name, email, password, token_verify, token_expire, is_verified})=>{
    ...
    return new Promise((resolve, reject)=>{
        ...
        .then((res)=>{
            if (res.rowCount > 0) {
                ...
                db.query(`
                    INSERT INTO users (name, email, password, token_verify, token_expire, is_verified)
                    VALUES ($1, $2, $3, $4, $5, $6)
                    RETURNING *`,
                    [name, email, password, token_verify, token_expire, is_verified])
                .then((res)=>{
                    resolve(res.rows)
                }).catch((err)=>{
                    reject(err)
